...
UserListToolbar.propTypes = {
  ...
  deleteOrgs : PropTypes.func
};

export default function UserListToolbar({ numSelected, filterName, onFilterName, deleteOrgs }) {
  return (
    <StyledRoot
      sx={{
        ...(numSelected > 0 && {
    ...
    >
      ...
      {numSelected > 0 ? (
        <Tooltip title="Delete" onClick={deleteOrgs}>
          <IconButton>
